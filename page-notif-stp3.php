    ...
    <body class="container-fluid">
        ...
        <div class="row">
            ...
            <ul class="nav flex-column mb-auto justify-content-center my-5">
                ...
                <li>
                    <div href="page-notif-stp3.php" class="nav-link link-dark bg-light" style="margin-left: 10px; border-top-left-radius: 10px; border-bottom-left-radius: 10px;">
                        <b>Step 3:</b> Post a Review
                    </div>
                </li>
                <li>
                    <a href="page-notif-stp4.php" class="nav-link link-dark" aria-current="page">
